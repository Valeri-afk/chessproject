...
namespace ui
{
    ...
    void AnimationSystem::advance(float dt) noexcept
    {
        ...
        {
            // The setter belongs to component code and can start/replace/cancel
            // animations. Work on a snapshot so vector reallocation cannot
            ...
            // The setter replaced or cancelled this animation. Do not touch
            // the newly created animation for the same property.
