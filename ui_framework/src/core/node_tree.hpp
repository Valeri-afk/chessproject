...
namespace ui
{
    ...
    public:
        ...
        private: NodeTree *tree_ = nullptr;
        };
        NodeTree() = default;
        ...
        template <typename Callback> void forEachRoot(Callback &&cb);
        template <typename Callback> void rForEachRoot(Callback &&cb);
        template <typename Callback> void forEachOverlay(Callback &&cb);
        template <typename Callback> void rForEachOverlay(Callback &&cb);
        template <typename Fn> void enqueueNodeMutation(Node &, Fn &&fn);
    ...
    private:
        struct Mutation { virtual ~Mutation() = default; virtual void operator()() = 0; };
        template <typename Fn> struct MutationImpl final : Mutation { explicit MutationImpl(Fn &&function):function(std::move(function)){} void operator()() override {function();} Fn function; };
        enum class TraversalResult { Continue, SkipChildren, Stop };
        ...
        template <typename Fn> void enqueueMutation(Fn &&fn);
